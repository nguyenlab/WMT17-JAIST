...
TRAIN_SRC=data/SETIMES2.train.$SRCLANG
TRAIN_TRG=data/SETIMES2.train.$TRGLANG
TUNE_SRC=data/newsdev2016-tren.truecase.$SRCLANG
TUNE_TRG=data/newsdev2016-tren.truecase.$TRGLANG
TEST_SRC=data/newstest2016-tren.truecase.$SRCLANG
TEST_TRG=data/newstest2016-tren.truecase.$TRGLANG
